# Generated by Django 2.0.10 on 2021-08-04 21:11
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('circles', '0003_auto_20210623_2053'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('used_by', models.ForeignKey(help_text='User that uses the code to enter the circle', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['used_at'],
